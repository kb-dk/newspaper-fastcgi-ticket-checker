...
my $goodTicket = '{"id":"3d2bda8b-8b7c-47e9-85ce-f42d2e4fc12d","type":"Thumbnail","ipAddress":"' . $goodIP . '","resources":["uuid:371157ee-b120-4504-bfaf-364c15a4137c"],"userAttributes":{"everybody":["yes"],"SBIPRoleMapper":["inhouse"]},"properties":null}';
# Ticket that should not allow the test host access
my $badTicket = '{"id":"3d2bda8b-8b7c-47e9-85ce-f42d2e4fcbad","type":"Thumbnail","ipAddress":"' . $badIP . '","resources":["uuid:371157ee-b120-4504-bfaf-364c15a41bad"],"userAttributes":{"everybody":["yes"],"SBIPRoleMapper":["inhouse"]},"properties":null}';
